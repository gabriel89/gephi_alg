...
public class GraphDistance implements Statistics, LongTask {
    ...
    public String getReport() {
        ...
        try {
            File tmp = new File(System.getProperty("user.home") + "/Desktop/betweenness.txt");
            PrintWriter pw = new PrintWriter(tmp);
            for(double d : betweenness)
            {
                pw.println(d);                
            }            
        ...
        try {
            File tmp = new File(System.getProperty("user.home") + "/Desktop/closeness.txt");
            PrintWriter pw = new PrintWriter(tmp);
            for(double d : closeness)
            {
                pw.println(d);                
            }            
