 ...
 * <p>
 * This statistic has no settings panel. It has however a final result to show
 * near the statistic name. This is configured with the <code>getValue()</code>
 * method.
 * 
...
public class CountSelfLoopUI implements StatisticsUI {
    ...
    public void setup(Statistics ststcs) {
        this.statistic = (CountSelfLoop) ststcs;
    }
