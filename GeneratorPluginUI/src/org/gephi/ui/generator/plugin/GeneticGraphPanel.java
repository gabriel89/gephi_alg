 ...
 */
public class GeneticGraphPanel extends javax.swing.JPanel {
     ...
     */
    public GeneticGraphPanel() {
        initComponents();
    }

    public static ValidationPanel createValidationPanel(GeneticGraphPanel innerPanel) {
        ValidationPanel validationPanel = new ValidationPanel();
        if (innerPanel == null) {
            innerPanel = new GeneticGraphPanel();
        }
    ...
    private void initComponents() {
        ...
        nodeLabel.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.nodeLabel.text_2")); // NOI18N

        edgeLabel.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.edgeLabel.text_2")); // NOI18N

        cellField.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.cellField.text_1")); // NOI18N

        intraEdgeField.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.intraEdgeField.text_1")); // NOI18N

        edgeLabel1.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.edgeLabel1.text_1")); // NOI18N

        interEdgeField.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.interEdgeField.text_1")); // NOI18N

        edgeLabel2.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.edgeLabel2.text_1")); // NOI18N

        cellSizeField.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.cellSizeField.text_1")); // NOI18N

        jSeparator1.setForeground(new java.awt.Color(0, 0, 204));

        animateCheckBox.setSelected(true);
        animateCheckBox.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.animateCheckBox.text")); // NOI18N
        ...
        labelResolution.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.labelResolution.text")); // NOI18N
        ...
        tAnimateNode.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.tAnimateNode.text")); // NOI18N

        labelResolution1.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution1.setLineWrap(true);
        labelResolution1.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.labelResolution1.text")); // NOI18N
        ...
        tAnimateEdge.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.tAnimateEdge.text")); // NOI18N

        labelResolution2.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution2.setLineWrap(true);
        labelResolution2.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.labelResolution2.text")); // NOI18N
        ...
        labelResolution3.setText(org.openide.util.NbBundle.getMessage(GeneticGraphPanel.class, "GeneticGraphPanel.labelResolution3.text")); // NOI18N
