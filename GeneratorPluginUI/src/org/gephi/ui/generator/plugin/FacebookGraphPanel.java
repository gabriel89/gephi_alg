 ...
 */
public class FacebookGraphPanel extends javax.swing.JPanel {
     ...
     */
    public FacebookGraphPanel() {
        initComponents();
    }

    public static ValidationPanel createValidationPanel(FacebookGraphPanel innerPanel) {
        ValidationPanel validationPanel = new ValidationPanel();
        if (innerPanel == null) {
            innerPanel = new FacebookGraphPanel();
        }
        ...
        group.add(innerPanel.intraEdgeField, Validators.REQUIRE_NON_EMPTY_STRING, new BetweenZeroAndOneValidator());
        group.add(innerPanel.interEdgeField, Validators.REQUIRE_NON_EMPTY_STRING, new BetweenZeroAndOneValidator());
    ...
    private void initComponents() {
        ...
        nodeLabel.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.nodeLabel.text_2")); // NOI18N

        edgeLabel.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.edgeLabel.text_2")); // NOI18N

        cellField.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.cellField.text_1")); // NOI18N

        intraEdgeField.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.intraEdgeField.text_1")); // NOI18N

        edgeLabel1.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.edgeLabel1.text_1")); // NOI18N

        interEdgeField.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.interEdgeField.text_1")); // NOI18N

        edgeLabel2.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.edgeLabel2.text_1")); // NOI18N

        cellSizeField.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.cellSizeField.text_1")); // NOI18N

        jSeparator1.setForeground(new java.awt.Color(0, 0, 204));

        animateCheckBox.setSelected(true);
        animateCheckBox.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.animateCheckBox.text")); // NOI18N
        ...
        labelResolution.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.labelResolution.text")); // NOI18N
        ...
        tAnimateNode.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.tAnimateNode.text")); // NOI18N

        labelResolution1.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution1.setLineWrap(true);
        labelResolution1.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.labelResolution1.text")); // NOI18N
        ...
        tAnimateEdge.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.tAnimateEdge.text")); // NOI18N

        labelResolution2.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution2.setLineWrap(true);
        labelResolution2.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.labelResolution2.text")); // NOI18N
        ...
        labelResolution3.setText(org.openide.util.NbBundle.getMessage(FacebookGraphPanel.class, "FacebookGraphPanel.labelResolution3.text")); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addComponent(labelResolution3, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
