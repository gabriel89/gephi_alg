 ...
 */
public class StaticGeographicGraphPanel extends javax.swing.JPanel {
     ...
     */
    public StaticGeographicGraphPanel() {
        initComponents();
    }

    public static ValidationPanel createValidationPanel(StaticGeographicGraphPanel innerPanel) {
        ValidationPanel validationPanel = new ValidationPanel();
        if (innerPanel == null) {
            innerPanel = new StaticGeographicGraphPanel();
        }
        ...
        group.add(innerPanel.maxDistField, Validators.REQUIRE_NON_EMPTY_STRING, new BetweenZeroAndOneValidator());
        group.add(innerPanel.socialField, Validators.REQUIRE_NON_EMPTY_STRING, new BetweenZeroAndOneValidator());
        group.add(innerPanel.paranoidField, Validators.REQUIRE_NON_EMPTY_STRING, new BetweenZeroAndOneValidator());
    ...
    private void initComponents() {
        ...
        socialField = new javax.swing.JTextField();
        edgeLabel2 = new javax.swing.JLabel();
        paranoidField = new javax.swing.JTextField();
        ...
        nodeLabel.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.nodeLabel.text_2")); // NOI18N

        edgeLabel.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.edgeLabel.text_2")); // NOI18N

        cellField.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.cellField.text_1")); // NOI18N

        maxDistField.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.intraEdgeField.text_1")); // NOI18N

        edgeLabel1.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.edgeLabel1.text_1")); // NOI18N

        socialField.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.interEdgeField.text_1")); // NOI18N

        edgeLabel2.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.edgeLabel2.text_1")); // NOI18N

        paranoidField.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.cellSizeField.text_1")); // NOI18N

        jSeparator1.setForeground(new java.awt.Color(0, 0, 204));

        animateCheckBox.setSelected(true);
        animateCheckBox.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.animateCheckBox.text")); // NOI18N
        ...
        labelResolution.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.labelResolution.text")); // NOI18N
        ...
        tAnimateNode.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.tAnimateNode.text")); // NOI18N

        labelResolution1.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution1.setLineWrap(true);
        labelResolution1.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.labelResolution1.text")); // NOI18N
        ...
        tAnimateEdge.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.tAnimateEdge.text")); // NOI18N

        labelResolution2.setForeground(new java.awt.Color(102, 102, 102));
        labelResolution2.setLineWrap(true);
        labelResolution2.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.labelResolution2.text")); // NOI18N
        ...
        labelResolution3.setText(org.openide.util.NbBundle.getMessage(StaticGeographicGraphPanel.class, "FacebookGraphPanel.labelResolution3.text")); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(paranoidField)
                                    .addComponent(maxDistField, javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(socialField, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 109, Short.MAX_VALUE))
                                .addGap(0, 0, Short.MAX_VALUE))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(socialField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(edgeLabel1))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(paranoidField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    protected javax.swing.JTextField paranoidField;
    protected javax.swing.JTextField socialField;
